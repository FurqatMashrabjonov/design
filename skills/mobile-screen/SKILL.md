...
od:
  ...
  platform: mobile
  craft:
    requires: [typography, typography-hierarchy, color, anti-ai-slop, state-coverage, accessibility-baseline, form-validation, animation-discipline]
---
...
4. Touch targets ≥ 44px. Bottom tab bar or a back button in the header, not both, unless the archetype needs it.
