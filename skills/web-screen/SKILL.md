...
3. Icons: `<i data-lucide="name"></i>`, coloured with `currentColor` (see the icons and fonts contract). Images: `https://placehold.co/WIDTHxHEIGHT` or CSS gradients, never a real-photo CDN.
