...
// Lucide 24x24 stroke geometry. The planner emits lucide-style icon names, and every
// screen must draw the SAME glyph — so the paths live here as data instead of being
// redrawn by the model on each parallel call.
const ICON_PATHS: Record<string, string> = {
  ...
  award: '<path d="m15.477 12.89 1.515 8.526a.5.5 0 0 1-.81.47l-3.58-2.687a1 1 0 0 0-1.197 0l-3.586 2.686a.5.5 0 0 1-.81-.47l1.514-8.526"/><circle cx="12" cy="8" r="6"/>',
