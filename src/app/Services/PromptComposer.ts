...
**Maps.** Never draw a map or ask for a map photo. Write \`<div data-od-map data-pins="Burger Palace, Home" data-route data-you></div>\` — a street plan with labelled pins is drawn for you; \`data-route\` joins the first pin to the last, \`data-you\` marks the user. It fills its container; give it a height if the container has none.
